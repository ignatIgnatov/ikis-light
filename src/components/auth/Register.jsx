  ...
  return (
    <div className="mt-32 px-2 flex flex-col justify-center items-center">
      <div className="w-full flex flex-col justify-center items-center gap-6">
        ...
        <div className="w-2/3 flex flex-col justify-center items-center gap-4 p-4 shadow-lg rounded-md bg-gray-100">
          <button
            className="flex items-center w-2/3 justify-center gap-3 bg-white border border-gray-300 px-4 py-2 text-lg text-gray-700 font-medium rounded-md transition-transform duration-500 transform hover:scale-105 hover:shadow-md"
        ...
        <div className="w-2/3 flex flex-row justify-center items-center gap-6 p-10 shadow-lg rounded-md bg-gray-100">
